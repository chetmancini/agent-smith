...
- `demo`: run an isolated full-loop sandbox that simulates Claude fixing a tiny todo app, emits tool-call telemetry, writes reports, drives the loop, and animates the TUI with a `Claude Working` pane
